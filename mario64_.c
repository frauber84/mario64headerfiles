...
void _start ( void )
{
    ...
    *nopbyte = 0x00000000;
    ...
    Pad *Joy2 = (void*)0x8033AFAC;
    *distance = *distance + *cameradistance; // update camera
    
    if ( Joy2->currentButton & BUTTON_D_UP && *counter2 > 3) 
    {
        *cameradistance += 0.3;
        *counter2 = 0;
    }
    else if ( Joy2->currentButton & BUTTON_D_DOWN && *counter2 > 3) 
    {
        *cameradistance -= 0.3;
        *counter2 = 0;
    }
...
//  	    ClosestObject->x_pos+=9.0f*sinf(angle*PI/180.0);
        ...
        *FireCounter = *FireCounter + 1;
        ...
        if (Controller2->currentButton & BUTTON_Z && *counter2 > 20 ) 
        {
