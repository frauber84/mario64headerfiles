...
void MenuPage05()
{
    ...
    if ( *list_pointer != 0 )
    {
        ...
        PrintInt(210, 160, "bhv %x", (u32)( (ClosestObject->behavior_script_entry - GetSegmentBase(0x13) ) & 0xFFFF) );
...
//        PrintInt(25, 100, "GFX %x", *obj_model_id);  // 12
...
/*        switch (*selection)
    ...
    *apointer =  0x8CA50070; //  LW A1, 0x0070 (A1)  Load ObjectDistanceSource
     ...
     PrintInt(20, 40, "e4 ", 0);
     PrintFloat(80, 40, ClosestObject->_0xe4, 2);
     PrintInt(20, 60, "170 ", 0);
     PrintFloat(80, 60, ClosestObject->_0x170, 2);
     PrintInt(20, 80, "174 ", 0);
     PrintFloat(80, 80, ClosestObject->_0x174, 2);
//     PrintInt(20, 100, "194 ", 0);
//     PrintFloat(80, 100, ClosestObject->collision_distance, 2);
       ...
       else
       {
        ...
        if (*segment[7] != *last_segment7) *list_pointer = 0;
...
//    PrintInt(125,120, "%x", (SoundList[*sound]) & 0xFFFF0000);
...
void MenuPage09()
{
    ...
    PrintInt(15,160,  "Controller1 status", 0);
